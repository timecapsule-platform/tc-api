...
class PlantDao extends Dao {
     ...
     * Creates a new plant
     * */
    public function createPlantsTransaction() 
    {
        ...
        //$raw = json_decode(file_get_contents("data/plants-raw-0-50000.json"),  true);
        //$raw = json_decode(file_get_contents("data/plants-raw-50000-100000.json"),  true);
        ...
        $raw = json_decode(file_get_contents("data/plants-raw-200000-250000.json"),  true);
